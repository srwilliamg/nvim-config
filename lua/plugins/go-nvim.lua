...
return {
  ...
  opts = {
    ...
    lint_prompt_style = "qflist",
    lint_on_save = true,
    golangci_lint = {
      config = "~/.golangci.yml", -- set to a config file path
      no_config = true, -- true: golangci-lint --no-config
    ...
    diagnostic = true, -- set to table to customize vim.diagnostic.config setup
    -- example setup:
